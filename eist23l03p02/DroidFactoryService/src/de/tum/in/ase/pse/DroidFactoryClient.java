...
public final class DroidFactoryClient {
	...
	*/
	...
	public void produceR2Async(InboxClient client) {
		String r2String = rest.postForObject(BASE_URL+R_2,createHttpEntity(Droids.R2), String.class);
		client.droidReadyR2(r2String);
	}
	//TODO 2.2: remove the old methods for producing droids and implement the async version
	public void produce3POAsync(InboxClient client) {
		String threePOString = rest.postForObject(BASE_URL+THREE_PO,createHttpEntity(Droids.THREE_PO), String.class);
		client.droidReady3PO(threePOString);
	}
