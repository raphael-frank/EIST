...
public class PersonResource {
    ...
    public ResponseEntity<List<Person>> getAllPersons(
            @RequestParam(value = "sortField") Optional<PersonSortingOptions.SortField> sortField,
            @RequestParam(value = "sortingOrder") Optional<PersonSortingOptions.SortingOrder> sortingOrder
    ) {
        return ResponseEntity.ok(personService.getAllPersons(
                new PersonSortingOptions(sortingOrder.orElse(PersonSortingOptions.SortingOrder.ASCENDING),
                        sortField.orElse(PersonSortingOptions.SortField.ID)))
        );
    }
}
